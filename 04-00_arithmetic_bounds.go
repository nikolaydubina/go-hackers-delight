...
func IsInRange[T Int](x, a, b T) bool { return uint(x-a) <= uint(b-a) }

// IsInRangeClosedOpen: a <= x < b
func IsInRangeClosedOpen[T Int](x, a, b T) bool { return uint(x-a) < uint(b-a) }

// IsInRangeOpenClosed: a < x <= b
func IsInRangeOpenClosed[T Int](x, a, b T) bool { return uint(b-x) < uint(b-a) }

// IsInRangeOpen: a < x < b
func IsInRangeOpen[T Int](x, a, b T) bool { return uint(x-a-1) < uint(b-a-1) }

func IsInRangeOpen2[T Int](x, a, b T) bool { return uint(b-x-1) < uint(b-a-1) }
