// Encoding multiple ints in single container (uin32, uint64) is possible by defining arithmetic operations on containers (uint32, uint64).
// This is especially useful for uint64 architectures.
package hd
